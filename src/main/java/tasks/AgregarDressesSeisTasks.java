...
public class AgregarDressesSeisTasks implements Task {

    public static AgregarDressesSeisTasks agregarDressesSeisTasks() {
        return Tasks.instrumented(AgregarDressesSeisTasks.class);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Enter.theValue("6").into(INPUT_CANTIDAD),
